...
const Register = function (props) {
  ...
  const tilt = (e, elementId) => {
    ...
    const layerX = e.clientX - cardRect.left;
    const layerY = e.clientY - cardRect.top;
    const percX = layerX / cardRect.width;
    const percY = layerY / cardRect.height;
    const tiltX = ((30 * percX) - 20);
    const tiltY = ((40 * percY) - 20) * -1;
      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            <button type="button">Sign up as a artist</button>
          </div>
        </div>
